<template>
  <div id="viewQuestionView">
    <a-row :gutter="[24, 24]">
      ...
      <a-col :md="12" :xs="24" style="border: 1px solid #eee; padding: 0px">
        <a-form :model="form" layout="inline" class="flex items-center justify-end bg-[#f2f3f5] p-2"
