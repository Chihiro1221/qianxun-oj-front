<template>
  <div id="addQuestionView" class="bg-white rounded shadow p-4">
    <h2>{{ updatePage ? "修改题目" : "新增题目" }}</h2>
    <a-form :model="form" label-align="left">
      ...
      <a-form-item field="difficulty" label="难度">
        <a-select v-model="form.difficulty" :style="{width:'320px'}" :default-value="1">
      ...
      <a-form-item label="判题配置" :content-flex="false" :merge-props="false">
        <a-space direction="vertical" style="min-width: 480px">
          <a-form-item field="judgeConfig.timeLimit" label="时间限制(ms)" label-col-style="width:400px">
            <a-input-number
